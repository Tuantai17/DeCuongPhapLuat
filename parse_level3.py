...
def parse_questions(filename, output_filename):
    ...
    # Extract Level 3 section
    start_match = re.search(r'3\.CẤP ĐỘ 3', content)
    end_match = re.search(r'4\.CẤP ĐỘ 4', content)
    
    if not start_match or not end_match:
        print("Could not find start (Level 3) or end (Level 4) markers.")
        return
...
def write_output(questions, output_filename):
    output_lines = []
    output_lines.append("# CẤP ĐỘ 3 - NHÓM CÂU HỎI KHÁ")
    output_lines.append("")
...
parse_questions(r'e:\DeCuongPhapLuat\DeCuongPhapLuat.md', r'e:\DeCuongPhapLuat\CauHoi_CapDo3.md')
