...
def parse_questions(filename, output_filename):
    ...
    # Extract Level 4 section
    start_match = re.search(r'4\.CẤP ĐỘ 4', content)
    end_match = re.search(r'5\.CẤP ĐỘ 5', content)
    
    if not start_match or not end_match:
        print("Could not find start (Level 4) or end (Level 5) markers.")
        return
...
def write_output(questions, output_filename):
    output_lines = []
    output_lines.append("# CẤP ĐỘ 4 - NHÓM CÂU HỎI KHÓ")
    output_lines.append("")
...
parse_questions(r'e:\DeCuongPhapLuat\DeCuongPhapLuat.md', r'e:\DeCuongPhapLuat\CauHoi_CapDo4.md')
